(() => {
    ...
    function initSliders() {
        if (document.querySelector(".bottom-article-blog__slider")) new core(".bottom-article-blog__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            speed: 800,
            navigation: {
                prevEl: ".navigation-blog__button_prev",
                nextEl: ".navigation-blog__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.15,
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            ...
            if (targetElement.classList.contains("top-header__button")) targetElement.closest(".top-header").classList.toggle("_hide");
        }
    };
    window["FLS"] = true;
    isWebp();
